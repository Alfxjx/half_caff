...
class ProfilePage extends StatelessWidget {
              ...
              children: [
                ...
                _ProfileSwitch(
                    ...
                    onChanged: (v) => controller
                        .updateProfile(profile.copyWith(isSmoker: v))),
                _ProfileSwitch(
                    title: l10n.oralContraceptivesLabel,
                    value: profile.usesOralContraceptives,
                    onChanged: (v) => controller.updateProfile(
                        profile.copyWith(usesOralContraceptives: v))),
                _ProfileSwitch(
                    title: l10n.pregnantLabel,
                    value: profile.isPregnant,
                    onChanged: (v) => controller
                        .updateProfile(profile.copyWith(isPregnant: v))),
                _ProfileSwitch(
                    title: l10n.drinksAlcoholLabel,
                    value: profile.drinksAlcohol,
                    onChanged: (v) => controller
                        .updateProfile(profile.copyWith(drinksAlcohol: v))),
                ...
                DropdownButtonFormField<LiverStatus>(
                  ...
                  items: LiverStatus.values
                      .map((s) => DropdownMenuItem(
                          value: s, child: Text(localizedLiverStatus(l10n, s))))
                      .toList(),
                  onChanged: (v) {
                    if (v != null)
                      controller
                          .updateProfile(profile.copyWith(liverStatus: v));
                  },
                ),
                const SizedBox(height: 12),
                DropdownButtonFormField<Cyp1a2Genotype>(
                  ...
                  items: Cyp1a2Genotype.values
                      .map((v) => DropdownMenuItem(
                          value: v, child: Text(localizedGenotype(l10n, v))))
                      .toList(),
                  onChanged: (v) {
                    if (v != null)
                      controller.updateProfile(profile.copyWith(genotype: v));
                  },
                ),
                const SizedBox(height: 20),
                ...
                Slider(
                  ...
                  onChanged: (v) => controller
                      .updateProfile(profile.copyWith(age: v.round())),
                ),
                ...
                Slider(
                  ...
                  onChanged: (v) => controller.updateProfile(
                      profile.copyWith(dailyBudgetMg: v.round())),
                ),
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    if (selected != null) {
                      controller.updateProfile(profile.copyWith(
                          targetSleepMinutes:
            ...
            child: Column(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  icon:
                      Icon(Icons.delete_forever_outlined, color: palette.error),
                  label: Text(l10n.clearAllDataButton,
  ...
  Future<void> _confirmClearData(
      BuildContext context, CaffeineJournalController controller) async {
    final l10n = AppLocalizations.of(context)!;
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            style:
                FilledButton.styleFrom(foregroundColor: context.palette.error),
